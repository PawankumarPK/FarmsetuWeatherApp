...
import 'package:farmsethu_weatherapp/apiService/url/Config.dart';
...
Future<List> fetchData(String lat, String lon, String city) async {
  var url =
      "https://api.openweathermap.org/data/2.5/onecall?lat=$lat&lon=$lon&units=metric&appid=${Config.appId}";
...
///------------------------ Fetch city lon & lat value from json & decode -------------------------
